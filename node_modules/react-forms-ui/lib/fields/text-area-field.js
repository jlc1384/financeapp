...
var _textAreaControl = require('../controls/text-area-control');
...
var TextAreaField = _react2.default.createClass({
	...
	render: function render() {
		...
		var _props = this.props,
		    ...
		    otherProps = _objectWithoutProperties(_props, ['id', 'label', 'classes', 'readonly', 'placeholder', 'row', 'rows', 'children']);
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_extends({ ref: function ref(el) {
					...
					onBlur: this._onBlur, formControl: true }, otherProps),
				children
			)
		);
	},

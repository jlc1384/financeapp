...
var _radiosControl = require('../controls/radios-control');

var _radiosControl2 = _interopRequireDefault(_radiosControl);
...
var RadiosField = _react2.default.createClass({
	displayName: 'RadiosField',
	...
	render: function render() {
		...
		var _props = this.props,
		    ...
		    otherProps = _objectWithoutProperties(_props, ['id', 'label', 'classes', 'data', 'readonly', 'row', 'children']);
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				_radiosControl2.default,
				_extends({ ref: function ref(el) {
						return _this.control = el;
					}, id: id, value: value, readonly: readonly, data: data,
					onChange: this.onChange, onBlur: this._onBlur, formControl: true }, otherProps),
				children
			)
		);
	},

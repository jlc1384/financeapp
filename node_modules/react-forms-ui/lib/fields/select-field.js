...
var _selectControl = require('../controls/select-control');
...
var SelectField = _react2.default.createClass({
	...
	render: function render() {
		...
		var _props = this.props,
		    ...
		    otherProps = _objectWithoutProperties(_props, ['id', 'label', 'classes', 'readonly', 'placeholder', 'load', 'formatItem', 'row', 'children']);
...
SelectField.propTypes = {
	...
	load: function load(props, propName, componentName) {
	...
	formatItem: _react2.default.PropTypes.func.isRequired
};

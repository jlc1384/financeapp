...
var DateField = _react2.default.createClass({
	...
	render: function render() {
		...
		var _props = this.props,
		    ...
		    otherProps = _objectWithoutProperties(_props, ['id', 'label', 'classes', 'readonly', 'placeholder', 'min', 'max', 'row', 'children']);
